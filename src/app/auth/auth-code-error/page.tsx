        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="space-y-4">
            <div className="grid gap-3">
              <Link
                href="/login"
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 px-4 rounded-xl hover:from-blue-700 hover:to-indigo-700 font-semibold transition-all duration-200 transform hover:scale-105 hover:shadow-lg text-center"
              >
